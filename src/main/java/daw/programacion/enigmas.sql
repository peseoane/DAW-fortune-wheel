...
INSERT INTO enigmas (contestada, enunciado)
VALUES (FALSE, 'No hay mal que por bien no venga'),
       (TRUE, 'A caballo regalado no se le miran los dientes'),
       (TRUE, 'El que mucho abarca, poco aprieta'),
       (TRUE, 'A buen entendedor, pocas palabras bastan'),
       ...
       (TRUE, 'Aunque la venda sea más grande que la herida, la herida sigue ahí'),
